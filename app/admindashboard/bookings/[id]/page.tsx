...
import { normalizeBooking, type BookingRecord } from "../bookingUtils";
...
export default async function BookingDetailsByRestaurantPage({ params }: BookingDetailsPageProps) {
    ...
    <div className="container mx-auto px-4 py-8 sm:py-12">
      <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Link href="/admindashboard/bookings">
          <button className="btn btn-primary w-full sm:w-auto">Back to all restaurants</button>
        </Link>
      </div>
